...
<body>
    ...
    <div id="main-wrapper">
        <div class="nav-header text-center"  style="background:#072756;">
        <div>     
                <h2 class="pt-3" style="color:white;">Employee Panel</h2>
            </div> 
        </div>
        <div class="header">    
                   ...
                   <!--- <li>
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="./profile.php"> <i class="fa fa-user menu-icon"></i><span class="nav-text">Personal Details</span></a></li>
                            <!---<li><a href="#"> <i class="fa fa-graduation-cap menu-icon"></i><span class="nav-text">Education Details</span></a></li>
                            <li><a href="#"> <i class="fa fa-briefcase menu-icon"></i><span class="nav-text">Work Experience</span></a></li> --->
                        </ul>
                    </li> 
