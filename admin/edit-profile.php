...
<?php  
    ...
    $sql = "SELECT * FROM organization WHERE email= '$session_email' ";
    ...
    $passErr=$orgnameErr = $emailErr  =  $addressErr = $empnameErr = $contactErr = $websiteErr = $gstnoErr ="";
    ...
    if( $_SERVER["REQUEST_METHOD"] == "POST" ){
        ...
        if( empty($_REQUEST["gstno"]) ){
            ...
            $gstno = $_REQUEST["gstno"];
                ...
                $result = mysqli_query($conn, "UPDATE `organization` SET `orgname`='$orgname',`email`='$email',`address`='$address',`employername`='$empname',`contact`=$contact,`website`='$website',`gstno`='$gstno' WHERE email='$_SESSION[email]' ");
