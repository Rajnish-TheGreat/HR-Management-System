    ...
    <div id="main-wrapper">
        <div class="nav-header"  style="background:#072756;">
             <div class="text-center">     
                <h2  style="color:white;">Organization Panel</h2>
            </div> 
        </div>
                ...
                <ul class="metismenu" id="menu">       
                    ...
                    <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="./manage-employee.php"> <i class="fa fa-tasks menu-icon"></i><span class="nav-text">View Employee</span></a></li>
                            <!-- <li><a href="./"> <i class="fa fa-bar-chart menu-icon"></i><span class="nav-text">Salary Table</span></a></li> -->
                        </ul>
                    </li>
                    <li>
                    <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="fa fa-address-card-o menu-icon"></i><span class="nav-text">Department and Salary</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="./manage-dept.php"> <i class="fa fa-tasks menu-icon"></i><span class="nav-text">View Department</span></a></li>
                            <!-- <li><a href="./manage-admin.php"> <i class="fa fa-tasks menu-icon"></i><span class="nav-text">Assign Designations</span></a></li>--->
                            <li><a href="./manage-salary.php"> <i class="fa fa-tasks menu-icon"></i><span class="nav-text">Salary</span></a></li>
                        </ul>
                    </li>
                    <li>
